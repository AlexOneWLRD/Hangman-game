import { WORDS, KEYBOARDS_LETTERS } from "./consts.js";
...
const createPlaceholdersHtml = () => {
  ...
  const placeholdersArray = Array.from(word);
...
const stopGame = (status) =>{
    ...
    <button id="play-again" class="button-primary px-5 py-5 mt-5">Play again</button>`;
...
export const startGame = () => {
  ...
  gameDiv.insertAdjacentHTML('beforeend',`<button id="quit" class="button-secondary px-2 py-1">Quit</button>`)
